from api.views.posts import BlogPostViewSet, BlogViewSet
...
urlpatterns = [
    ...
    path(
        ...
        SubscriptionViewSet.as_view({"get": "user_subscriptions"}),
    ...
    path("v1/blog-posts/create/", BlogPostViewSet.as_view({"post": "create"}), name="blog-post-create"),
    path("v1/blog-posts/<int:pk>/delete/", BlogPostViewSet.as_view({"delete": "destroy"}), name="blog-post-delete"),
]
